...
and time of neutron capture events relative to the centre.
 ...
 1- GEOMETRY DEFINITION                                                   
   ...
   The setup consists of a an envelope of box shaped water.                             
...
B1:
 ...
 5- DETECTOR RESPONSE
   ...
   At end of event, the value acummulated in EventAction is added in RunAction
   and summed over the whole run (see EventAction::EndOfevent()).

   Total dose deposited is computed at RunAction::EndOfRunAction(), 
   ...
   workers is merged to the master in RunAction::EndOfRunAction() and the final
   result is printed on the screen.
   
   G4Parameter<G4double> type instead of G4double type is used for the RunAction
